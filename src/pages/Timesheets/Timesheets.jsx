        ...
        <div className="timesheets-wrapper">
            ...
            <div className="timesheets-container">
                ...
                <form className="timesheets-form">
                    ...
                    <button type="button" className="styled-button" onClick={handleSave}>Save</button>
                </form>
                            ...
                            {entries.map((entry, index) => (
                                <li key={index}>
                                    <div className="entry-details">
                                        <div className="entry-date"><strong>Date:</strong> {entry.date}</div>
                                        <div className="entry-task"><strong>Task:</strong> {entry.task}</div>
                                        <div className="entry-hours"><strong>Hours:</strong> {entry.hoursWorked}</div>
                                    </div>
                                    <button 
